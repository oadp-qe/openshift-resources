...
class AWSElasticBlockStoreVolumeSourceV2(BaseModel):
    fsType: Optional[str] = Field(
        None,
...
class AzureDiskVolumeSourceV2(BaseModel):
    cachingMode: Optional[str] = Field(
...
class AzureFileVolumeSourceV2(BaseModel):
    readOnly: Optional[bool] = Field(
        None,
        description='Defaults to false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts.',
    )
...
class ImagePullPolicyModel1(Enum):
    Always = 'Always'
    IfNotPresent = 'IfNotPresent'
    Never = 'Never'


class TerminationMessagePolicyModel1(Enum):
    FallbackToLogsOnError = 'FallbackToLogsOnError'
    File = 'File'


class ImagePullPolicyModel2(Enum):
    Always = 'Always'
    IfNotPresent = 'IfNotPresent'
    Never = 'Never'


class TerminationMessagePolicyModel2(Enum):
    FallbackToLogsOnError = 'FallbackToLogsOnError'
    File = 'File'
...
class FCVolumeSourceV2(BaseModel):
    fsType: Optional[str] = Field(
        None,
        description='Filesystem type to mount. Must be a filesystem type supported by the host operating system. Ex. "ext4", "xfs", "ntfs". Implicitly inferred to be "ext4" if unspecified.',
    )
...
class FlockerVolumeSourceV2(BaseModel):
    datasetName: Optional[str] = Field(
        None,
...
class GCEPersistentDiskVolumeSourceV2(BaseModel):
    fsType: Optional[str] = Field(
        None,
...
class GitRepoVolumeSourceV2(BaseModel):
    directory: Optional[str] = Field(
        None,
...
class GlusterfsVolumeSourceV2(BaseModel):
    endpoints: str = Field(
        ...,
...
class HostPathVolumeSourceV2(BaseModel):
    path: str = Field(
        ...,
        description='Path of the directory on the host. If the path is a symlink, it will follow the link to the real path. More info: https://kubernetes.io/docs/concepts/storage/volumes#hostpath',
    )
...
class NFSVolumeSourceV2(BaseModel):
    path: str = Field(
        ...,
        description='Path that is exported by the NFS server. More info: https://kubernetes.io/docs/concepts/storage/volumes#nfs',
    )
...
class PersistentVolumeClaimVolumeSourceV2(BaseModel):
    claimName: str = Field(
        ...,
        description='ClaimName is the name of a PersistentVolumeClaim in the same namespace as the pod using this volume. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims',
    )
...
class PhotonPersistentDiskVolumeSourceV2(BaseModel):
    fsType: Optional[str] = Field(
        None,
        description='Filesystem type to mount. Must be a filesystem type supported by the host operating system. Ex. "ext4", "xfs", "ntfs". Implicitly inferred to be "ext4" if unspecified.',
    )
...
class PodReadinessGateV2(BaseModel):
...
class PortworxVolumeSourceV2(BaseModel):
    fsType: Optional[str] = Field(
        None,
        description='FSType represents the filesystem type to mount Must be a filesystem type supported by the host operating system. Ex. "ext4", "xfs". Implicitly inferred to be "ext4" if unspecified.',
    )
...
class QuobyteVolumeSourceV2(BaseModel):
    group: Optional[str] = Field(
        None, description='Group to map volume access to Default is no group'
    )
    readOnly: Optional[bool] = Field(
...
class RBDVolumeSourceV2(BaseModel):
    fsType: Optional[str] = Field(
        None,
...
class ScaleIOVolumeSourceV2(BaseModel):
    fsType: Optional[str] = Field(
        None,
...
class ScopedResourceSelectorRequirementV2(BaseModel):
    operator: OperatorModel1 = Field(
        ...,
        description='Represents a scope\'s relationship to a set of values. Valid operators are In, NotIn, Exists, DoesNotExist.\n\nPossible enum values:\n - `"DoesNotExist"`\n - `"Exists"`\n - `"In"`\n - `"NotIn"`',
    )
    scopeName: ScopeNameModel = Field(
        ...,
...
class SecretProjectionV2(BaseModel):
    items: Optional[List[KeyToPathV2]] = Field(
        None,
...
class SecretVolumeSourceV2(BaseModel):
    defaultMode: Optional[int] = Field(
        None,
...
class ServiceAccountTokenProjectionV2(BaseModel):
    audience: Optional[str] = Field(
        None,
        description='Audience is the intended audience of the token. A recipient of a token must identify itself with an identifier specified in the audience of the token, and otherwise should reject the token. The audience defaults to the identifier of the apiserver.',
    )
...
class StorageOSVolumeSourceV2(BaseModel):
    fsType: Optional[str] = Field(
        None,
        description='Filesystem type to mount. Must be a filesystem type supported by the host operating system. Ex. "ext4", "xfs", "ntfs". Implicitly inferred to be "ext4" if unspecified.',
    )
...
class Toleration(BaseModel):
    ...
    operator: Optional[OperatorModel2] = Field(
        None,
...
class WhenUnsatisfiableModel(Enum):
    DoNotSchedule = 'DoNotSchedule'
    ScheduleAnyway = 'ScheduleAnyway'
...
class VsphereVirtualDiskVolumeSourceV2(BaseModel):
    fsType: Optional[str] = Field(
        None,
        description='Filesystem type to mount. Must be a filesystem type supported by the host operating system. Ex. "ext4", "xfs", "ntfs". Implicitly inferred to be "ext4" if unspecified.',
    )
...
class CSIVolumeSourceV2(BaseModel):
    driver: str = Field(
        ...,
        description='Driver is the name of the CSI driver that handles this volume. Consult with your admin for the correct name as registered in the cluster.',
    )
...
class CephFSVolumeSourceV2(BaseModel):
    monitors: List[str] = Field(
        ...,
...
class CinderVolumeSourceV2(BaseModel):
    fsType: Optional[str] = Field(
        None,
...
class ConfigMapProjectionV2(BaseModel):
    items: Optional[List[KeyToPathV2]] = Field(
        None,
        description="If unspecified, each key-value pair in the Data field of the referenced ConfigMap will be projected into the volume as a file whose name is the key and content is the value. If specified, the listed keys will be projected into the specified paths, and unlisted keys will not be present. If a key is specified which is not present in the ConfigMap, the volume setup will error unless it is marked optional. Paths must be relative and may not contain the '..' path or start with '..'.",
    )
...
class ConfigMapVolumeSourceV2(BaseModel):
    defaultMode: Optional[int] = Field(
        None,
        description='Optional: mode bits used to set permissions on created files by default. Must be an octal value between 0000 and 0777 or a decimal value between 0 and 511. YAML accepts both octal and decimal values, JSON requires decimal values for mode bits. Defaults to 0644. Directories within the path are not affected by this setting. This might be in conflict with other options that affect the file mode, like fsGroup, and the result can be other mode bits set.',
    )
...
class EmptyDirVolumeSourceV2(BaseModel):
    medium: Optional[str] = Field(
        None,
...
class FlexVolumeSourceV2(BaseModel):
    driver: str = Field(
        ..., description='Driver is the name of the driver to use for this volume.'
    )
    fsType: Optional[str] = Field(
...
class ISCSIVolumeSourceV2(BaseModel):
    chapAuthDiscovery: Optional[bool] = Field(
...
class NamespaceConditionV2(BaseModel):
    lastTransitionTime: Optional[v1.Time] = None
    message: Optional[str] = None
    reason: Optional[str] = None
    status: str = Field(
...
class ServiceSpec(BaseModel):
    ...
    externalTrafficPolicy: Optional[ExternalTrafficPolicy] = Field(
        None,
...
class PersistentVolumeClaimSpecV2(BaseModel):
    accessModes: Optional[List[str]] = Field(
        None,
        description='AccessModes contains the desired access modes the volume should have. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#access-modes-1',
    )
...
class PersistentVolumeSpec(BaseModel):
    ...
    persistentVolumeReclaimPolicy: Optional[PersistentVolumeReclaimPolicy] = Field(
        None,
...
class PodAffinityTermV2(BaseModel):
    labelSelector: Optional[v1.LabelSelector] = Field(
        None, description='A label query over a set of resources, in this case pods.'
    )
    namespaceSelector: Optional[v1.LabelSelector] = Field(
...
class PodStatus(BaseModel):
    ...
    qosClass: Optional[QosClass] = Field(
        None,
...
class TopologySpreadConstraintV2(BaseModel):
    labelSelector: Optional[v1.LabelSelector] = Field(
        None,
        description='LabelSelector is used to find matching pods. Pods that match this label selector are counted to determine the number of pods in their corresponding topology domain.',
    )
    ...
    whenUnsatisfiable: WhenUnsatisfiableModel = Field(
        ...,
        description='WhenUnsatisfiable indicates how to deal with a pod if it doesn\'t satisfy the spread constraint. - DoNotSchedule (default) tells the scheduler not to schedule it. - ScheduleAnyway tells the scheduler to schedule the pod in any location,\n  but giving higher precedence to topologies that would help reduce the\n  skew.\nA constraint is considered "Unsatisfiable" for an incoming pod if and only if every possible node assignment for that pod would violate "MaxSkew" on some topology. For example, in a 3-zone cluster, MaxSkew is set to 1, and pods with the same labelSelector spread as 3/1/1: | zone1 | zone2 | zone3 | | P P P |   P   |   P   | If WhenUnsatisfiable is set to DoNotSchedule, incoming pod can only be scheduled to zone2(zone3) to become 3/2/1(3/1/2) as ActualSkew(2-1) on zone2(zone3) satisfies MaxSkew(1). In other words, the cluster can still be imbalanced, but scheduler won\'t make it *more* imbalanced. It\'s a required field.\n\nPossible enum values:\n - `"DoNotSchedule"` instructs the scheduler not to schedule the pod when constraints are not satisfied.\n - `"ScheduleAnyway"` instructs the scheduler to schedule the pod even if constraints are not satisfied.',
    )
...
class VolumeProjectionV2(BaseModel):
    configMap: Optional[ConfigMapProjectionV2] = Field(
    ...
    secret: Optional[SecretProjectionV2] = Field(
        None, description='information about the secret data to project'
    )
    serviceAccountToken: Optional[ServiceAccountTokenProjectionV2] = Field(
...
class ContainerV2(BaseModel):
    ...
    imagePullPolicy: Optional[ImagePullPolicyModel] = Field(
        None,
        description='Image pull policy. One of Always, Never, IfNotPresent. Defaults to Always if :latest tag is specified, or IfNotPresent otherwise. Cannot be updated. More info: https://kubernetes.io/docs/concepts/containers/images#updating-images\n\nPossible enum values:\n - `"Always"` means that kubelet always attempts to pull the latest image. Container will fail If the pull fails.\n - `"IfNotPresent"` means that kubelet pulls if the image isn\'t present on disk. Container will fail if the image isn\'t present and the pull fails.\n - `"Never"` means that kubelet never pulls an image, but only uses a local image. Container will fail if the image isn\'t present',
    )
    lifecycle: Optional[Lifecycle] = Field(
    ...
    livenessProbe: Optional[ProbeV2] = Field(
        None,
        description='Periodic probe of container liveness. Container will be restarted if the probe fails. Cannot be updated. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes',
    )
    name: str = Field(
    ...
    readinessProbe: Optional[ProbeV2] = Field(
        None,
        description='Periodic probe of container service readiness. Container will be removed from service endpoints if the probe fails. Cannot be updated. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes',
    )
    resources: Optional[ResourceRequirements] = Field(
    ...
    startupProbe: Optional[ProbeV2] = Field(
        None,
        description="StartupProbe indicates that the Pod has successfully initialized. If specified, no other probes are executed until this completes successfully. If this probe fails, the Pod will be restarted, just as if the livenessProbe failed. This can be used to provide different probe parameters at the beginning of a Pod's lifecycle, when it might take a long time to load data or warm a cache, than during steady-state operation. This cannot be updated. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes",
    )
    stdin: Optional[bool] = Field(
    ...
    terminationMessagePolicy: Optional[TerminationMessagePolicyModel] = Field(
        None,
        description='Indicate how the termination message should be populated. File will use the contents of terminationMessagePath to populate the container status message on both success and failure. FallbackToLogsOnError will use the last chunk of container log output if the termination message file is empty and the container exited with an error. The log output is limited to 2048 bytes or 80 lines, whichever is smaller. Defaults to File. Cannot be updated.\n\nPossible enum values:\n - `"FallbackToLogsOnError"` will read the most recent contents of the container logs for the container status message when the container exits with an error and the terminationMessagePath has no contents.\n - `"File"` is the default behavior and will set the container status message to the contents of the container\'s terminationMessagePath when the container exits.',
    )
    tty: Optional[bool] = Field(
...
class EphemeralContainer(BaseModel):
    ...
    imagePullPolicy: Optional[ImagePullPolicyModel1] = Field(
        None,
        description='Image pull policy. One of Always, Never, IfNotPresent. Defaults to Always if :latest tag is specified, or IfNotPresent otherwise. Cannot be updated. More info: https://kubernetes.io/docs/concepts/containers/images#updating-images\n\nPossible enum values:\n - `"Always"` means that kubelet always attempts to pull the latest image. Container will fail If the pull fails.\n - `"IfNotPresent"` means that kubelet pulls if the image isn\'t present on disk. Container will fail if the image isn\'t present and the pull fails.\n - `"Never"` means that kubelet never pulls an image, but only uses a local image. Container will fail if the image isn\'t present',
    )
    lifecycle: Optional[Lifecycle] = Field(
    ...
    terminationMessagePolicy: Optional[TerminationMessagePolicyModel1] = Field(
        None,
        description='Indicate how the termination message should be populated. File will use the contents of terminationMessagePath to populate the container status message on both success and failure. FallbackToLogsOnError will use the last chunk of container log output if the termination message file is empty and the container exited with an error. The log output is limited to 2048 bytes or 80 lines, whichever is smaller. Defaults to File. Cannot be updated.\n\nPossible enum values:\n - `"FallbackToLogsOnError"` will read the most recent contents of the container logs for the container status message when the container exits with an error and the terminationMessagePath has no contents.\n - `"File"` is the default behavior and will set the container status message to the contents of the container\'s terminationMessagePath when the container exits.',
    )
    tty: Optional[bool] = Field(
...
class EphemeralContainerV2(BaseModel):
    args: Optional[List[str]] = Field(
        None,
        description='Arguments to the entrypoint. The docker image\'s CMD is used if this is not provided. Variable references $(VAR_NAME) are expanded using the container\'s environment. If a variable cannot be resolved, the reference in the input string will be unchanged. Double $$ are reduced to a single $, which allows for escaping the $(VAR_NAME) syntax: i.e. "$$(VAR_NAME)" will produce the string literal "$(VAR_NAME)". Escaped references will never be expanded, regardless of whether the variable exists or not. Cannot be updated. More info: https://kubernetes.io/docs/tasks/inject-data-application/define-command-argument-container/#running-a-command-in-a-shell',
    )
    ...
    imagePullPolicy: Optional[ImagePullPolicyModel2] = Field(
        None,
        description='Image pull policy. One of Always, Never, IfNotPresent. Defaults to Always if :latest tag is specified, or IfNotPresent otherwise. Cannot be updated. More info: https://kubernetes.io/docs/concepts/containers/images#updating-images\n\nPossible enum values:\n - `"Always"` means that kubelet always attempts to pull the latest image. Container will fail If the pull fails.\n - `"IfNotPresent"` means that kubelet pulls if the image isn\'t present on disk. Container will fail if the image isn\'t present and the pull fails.\n - `"Never"` means that kubelet never pulls an image, but only uses a local image. Container will fail if the image isn\'t present',
    )
    lifecycle: Optional[Lifecycle] = Field(
    ...
    terminationMessagePolicy: Optional[TerminationMessagePolicyModel2] = Field(
        None,
        description='Indicate how the termination message should be populated. File will use the contents of terminationMessagePath to populate the container status message on both success and failure. FallbackToLogsOnError will use the last chunk of container log output if the termination message file is empty and the container exited with an error. The log output is limited to 2048 bytes or 80 lines, whichever is smaller. Defaults to File. Cannot be updated.\n\nPossible enum values:\n - `"FallbackToLogsOnError"` will read the most recent contents of the container logs for the container status message when the container exits with an error and the terminationMessagePath has no contents.\n - `"File"` is the default behavior and will set the container status message to the contents of the container\'s terminationMessagePath when the container exits.',
    )
    tty: Optional[bool] = Field(
...
class ProjectedVolumeSourceV2(BaseModel):
    defaultMode: Optional[int] = Field(
        None,
        description='Mode bits used to set permissions on created files by default. Must be an octal value between 0000 and 0777 or a decimal value between 0 and 511. YAML accepts both octal and decimal values, JSON requires decimal values for mode bits. Directories within the path are not affected by this setting. This might be in conflict with other options that affect the file mode, like fsGroup, and the result can be other mode bits set.',
    )
    sources: Optional[List[VolumeProjectionV2]] = Field(
...
class VolumeV2(BaseModel):
    awsElasticBlockStore: Optional[AWSElasticBlockStoreVolumeSourceV2] = Field(
        None,
        description="AWSElasticBlockStore represents an AWS Disk resource that is attached to a kubelet's host machine and then exposed to the pod. More info: https://kubernetes.io/docs/concepts/storage/volumes#awselasticblockstore",
    )
    azureDisk: Optional[AzureDiskVolumeSourceV2] = Field(
        None,
        description='AzureDisk represents an Azure Data Disk mount on the host and bind mount to the pod.',
    )
    azureFile: Optional[AzureFileVolumeSourceV2] = Field(
        None,
        description='AzureFile represents an Azure File Service mount on the host and bind mount to the pod.',
    )
    cephfs: Optional[CephFSVolumeSourceV2] = Field(
        None,
        description="CephFS represents a Ceph FS mount on the host that shares a pod's lifetime",
    )
    cinder: Optional[CinderVolumeSourceV2] = Field(
        None,
        description='Cinder represents a cinder volume attached and mounted on kubelets host machine. More info: https://examples.k8s.io/mysql-cinder-pd/README.md',
    )
    configMap: Optional[ConfigMapVolumeSourceV2] = Field(
        None,
        description='ConfigMap represents a configMap that should populate this volume',
    )
    csi: Optional[CSIVolumeSourceV2] = Field(
        None,
        description='CSI (Container Storage Interface) represents ephemeral storage that is handled by certain external CSI drivers (Beta feature).',
    )
    downwardAPI: Optional[DownwardAPIVolumeSource] = Field(
    ...
    emptyDir: Optional[EmptyDirVolumeSourceV2] = Field(
        None,
        description="EmptyDir represents a temporary directory that shares a pod's lifetime. More info: https://kubernetes.io/docs/concepts/storage/volumes#emptydir",
    )
    ephemeral: Optional[EphemeralVolumeSource] = Field(
    ...
    fc: Optional[FCVolumeSourceV2] = Field(
        None,
        description="FC represents a Fibre Channel resource that is attached to a kubelet's host machine and then exposed to the pod.",
    )
    flexVolume: Optional[FlexVolumeSourceV2] = Field(
        None,
        description='FlexVolume represents a generic volume resource that is provisioned/attached using an exec based plugin.',
    )
    flocker: Optional[FlockerVolumeSourceV2] = Field(
        None,
        description="Flocker represents a Flocker volume attached to a kubelet's host machine. This depends on the Flocker control service being running",
    )
    gcePersistentDisk: Optional[GCEPersistentDiskVolumeSourceV2] = Field(
        None,
        description="GCEPersistentDisk represents a GCE Disk resource that is attached to a kubelet's host machine and then exposed to the pod. More info: https://kubernetes.io/docs/concepts/storage/volumes#gcepersistentdisk",
    )
    gitRepo: Optional[GitRepoVolumeSourceV2] = Field(
        None,
        description="GitRepo represents a git repository at a particular revision. DEPRECATED: GitRepo is deprecated. To provision a container with a git repo, mount an EmptyDir into an InitContainer that clones the repo using git, then mount the EmptyDir into the Pod's container.",
    )
    glusterfs: Optional[GlusterfsVolumeSourceV2] = Field(
        None,
        description="Glusterfs represents a Glusterfs mount on the host that shares a pod's lifetime. More info: https://examples.k8s.io/volumes/glusterfs/README.md",
    )
    hostPath: Optional[HostPathVolumeSourceV2] = Field(
        None,
        description='HostPath represents a pre-existing file or directory on the host machine that is directly exposed to the container. This is generally used for system agents or other privileged things that are allowed to see the host machine. Most containers will NOT need this. More info: https://kubernetes.io/docs/concepts/storage/volumes#hostpath',
    )
    iscsi: Optional[ISCSIVolumeSourceV2] = Field(
        None,
        description="ISCSI represents an ISCSI Disk resource that is attached to a kubelet's host machine and then exposed to the pod. More info: https://examples.k8s.io/volumes/iscsi/README.md",
    )
    name: str = Field(
    ...
    nfs: Optional[NFSVolumeSourceV2] = Field(
        None,
        description="NFS represents an NFS mount on the host that shares a pod's lifetime More info: https://kubernetes.io/docs/concepts/storage/volumes#nfs",
    )
    persistentVolumeClaim: Optional[PersistentVolumeClaimVolumeSourceV2] = Field(
        None,
        description='PersistentVolumeClaimVolumeSource represents a reference to a PersistentVolumeClaim in the same namespace. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims',
    )
    photonPersistentDisk: Optional[PhotonPersistentDiskVolumeSourceV2] = Field(
        None,
        description='PhotonPersistentDisk represents a PhotonController persistent disk attached and mounted on kubelets host machine',
    )
    portworxVolume: Optional[PortworxVolumeSourceV2] = Field(
        None,
        description='PortworxVolume represents a portworx volume attached and mounted on kubelets host machine',
    )
    projected: Optional[ProjectedVolumeSourceV2] = Field(
        None,
        description='Items for all in one resources secrets, configmaps, and downward API',
    )
    quobyte: Optional[QuobyteVolumeSourceV2] = Field(
        None,
        description="Quobyte represents a Quobyte mount on the host that shares a pod's lifetime",
    )
    rbd: Optional[RBDVolumeSourceV2] = Field(
        None,
        description="RBD represents a Rados Block Device mount on the host that shares a pod's lifetime. More info: https://examples.k8s.io/volumes/rbd/README.md",
    )
    scaleIO: Optional[ScaleIOVolumeSourceV2] = Field(
        None,
        description='ScaleIO represents a ScaleIO persistent volume attached and mounted on Kubernetes nodes.',
    )
    secret: Optional[SecretVolumeSourceV2] = Field(
        None,
        description='Secret represents a secret that should populate this volume. More info: https://kubernetes.io/docs/concepts/storage/volumes#secret',
    )
    storageos: Optional[StorageOSVolumeSourceV2] = Field(
        None,
        description='StorageOS represents a StorageOS volume attached and mounted on Kubernetes nodes.',
    )
    vsphereVolume: Optional[VsphereVirtualDiskVolumeSourceV2] = Field(
        None,
        description='VsphereVolume represents a vSphere volume attached and mounted on kubelets host machine',
    )
...
class PodSpecV2(BaseModel):
    ...
    containers: List[ContainerV2] = Field(
        ...,
        description='List of containers belonging to the pod. Containers cannot currently be added or removed. There must be at least one container in a Pod. Cannot be updated.',
    )
    dnsConfig: Optional[PodDNSConfig] = Field(
    ...
    dnsPolicy: Optional[DnsPolicyModel] = Field(
        None,
        description='Set DNS policy for the pod. Defaults to "ClusterFirst". Valid values are \'ClusterFirstWithHostNet\', \'ClusterFirst\', \'Default\' or \'None\'. DNS parameters given in DNSConfig will be merged with the policy selected with DNSPolicy. To have DNS options set along with hostNetwork, you have to specify DNS policy explicitly to \'ClusterFirstWithHostNet\'.\n\nPossible enum values:\n - `"ClusterFirst"` indicates that the pod should use cluster DNS first unless hostNetwork is true, if it is available, then fall back on the default (as determined by kubelet) DNS settings.\n - `"ClusterFirstWithHostNet"` indicates that the pod should use cluster DNS first, if it is available, then fall back on the default (as determined by kubelet) DNS settings.\n - `"Default"` indicates that the pod should use the default (as determined by kubelet) DNS settings.\n - `"None"` indicates that the pod should use empty DNS settings. DNS parameters such as nameservers and search paths should be defined via DNSConfig.',
    )
    enableServiceLinks: Optional[bool] = Field(
    ...
    ephemeralContainers: Optional[List[EphemeralContainerV2]] = Field(
        None,
        description="List of ephemeral containers run in this pod. Ephemeral containers may be run in an existing pod to perform user-initiated actions such as debugging. This list cannot be specified when creating a pod, and it cannot be modified by updating the pod spec. In order to add an ephemeral container to an existing pod, use the pod's ephemeralcontainers subresource. This field is beta-level and available on clusters that haven't disabled the EphemeralContainers feature gate.",
    )
    hostAliases: Optional[List[HostAlias]] = Field(
    ...
    initContainers: Optional[List[ContainerV2]] = Field(
        None,
        description='List of initialization containers belonging to the pod. Init containers are executed in order prior to containers being started. If any init container fails, the pod is considered to have failed and is handled according to its restartPolicy. The name for an init container or normal container must be unique among all containers. Init containers may not have Lifecycle actions, Readiness probes, Liveness probes, or Startup probes. The resourceRequirements of an init container are taken into account during scheduling by finding the highest request/limit for each resource type, and then using the max of of that value or the sum of the normal containers. Limits are applied to init containers in a similar fashion. Init containers cannot currently be added or removed. Cannot be updated. More info: https://kubernetes.io/docs/concepts/workloads/pods/init-containers/',
    )
    nodeName: Optional[str] = Field(
    ...
    readinessGates: Optional[List[PodReadinessGateV2]] = Field(
        None,
        description='If specified, all readiness gates will be evaluated for pod readiness. A pod is ready when all its containers are ready AND all conditions specified in the readiness gates have status equal to "True" More info: https://git.k8s.io/enhancements/keps/sig-network/580-pod-readiness-gates',
    )
    restartPolicy: Optional[RestartPolicyModel] = Field(
        None,
        description='Restart policy for all containers within the pod. One of Always, OnFailure, Never. Default to Always. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle/#restart-policy\n\nPossible enum values:\n - `"Always"`\n - `"Never"`\n - `"OnFailure"`',
    )
    runtimeClassName: Optional[str] = Field(
    ...
    topologySpreadConstraints: Optional[List[TopologySpreadConstraintV2]] = Field(
        None,
        description='TopologySpreadConstraints describes how a group of pods ought to spread across topology domains. Scheduler will schedule pods in a way which abides by the constraints. All topologySpreadConstraints are ANDed.',
    )
    volumes: Optional[List[VolumeV2]] = Field(
        None,
        description='List of volumes that can be mounted by containers belonging to the pod. More info: https://kubernetes.io/docs/concepts/storage/volumes',
    )
